...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Analyse comparative de stratégies d'investissement</p>
            <div class="meta">
                Période : {start_date} → {end_date}<br>
                Benchmark : <span class="ticker-list">{benchmark_ticker}</span><br>
                Univers : <span class="ticker-list">{', '.join(tickers[:5])}</span> + {len(tickers)-5} autres
            </div>
        </header>

        <div class="section">
            <h2>Stratégie Buy & Hold — Benchmark</h2>
            <p class="description">
                Performance d'une stratégie d'achat et conservation simple sur l'indice S&P 500. 
                Cette stratégie sert de référence pour évaluer les performances des autres approches.
            </p>
        ...
        <div class="section">
            <h2>Stratégie Equal-Weighted</h2>
            <p class="description">
                Une approche qui alloue un poids égal à chaque action de l'univers, 
                rééquilibrée mensuellement. Cette méthode évite la concentration excessive sur les grandes capitalisations.
            </p>
            <div class="chart-container">
        ...
        <div class="section">
            <h2>Drawdown du Benchmark</h2>
            <p class="description">
                Le drawdown mesure la baisse maximale depuis le sommet le plus haut. 
                Il illustre le risque de perte potentielle et la volatilité de la stratégie.
            </p>
            <div class="chart-container">
                <img src="data:image/png;base64,{dd_img}" alt="Benchmark Drawdown">
            </div>
            <div class="highlight-box">
                <strong>Drawdown Maximum :</strong> {bench_dd_min:.2%}
            </div>
        </div>
        ...
        <div class="section">
            ...
            <p class="description">
                Histogramme des rendements mensuels du benchmark. 
                Cette visualisation permet d'observer la distribution statistique et d'identifier la normalité des rendements.
            </p>
            <div class="chart-container">
        ...
        <div class="section">
            ...
            <p class="description">
                Comparaison entre la stratégie Momentum (12-1), la stratégie Equal-Weighted et le Benchmark. 
                La stratégie Momentum sélectionne les 5 actions avec la meilleure performance sur 12 mois (excluant le dernier mois).
            </p>
            <div class="chart-container">
        ...
        <div class="section">
            ...
            <p class="description">
                Tableau récapitulatif des métriques clés : rendement annualisé (CAGR), volatilité, 
                ratio de Sharpe et drawdown maximum. Taux sans risque : 4.25%.
            </p>
            <div class="chart-container">
                {stats_html}
            </div>
        ...
        <footer>
            <p>Rapport généré le {datetime.datetime.now().strftime('%d/%m/%Y à %H:%M')}</p>
            <p style="margin-top: 10px; font-size: 0.8rem;">Les performances passées ne préjugent pas des résultats futurs.</p>
        </footer>
    </div>
</body>
</html>"""
...
def main():
    ...
    # Momentum strategy
    print("🎯 Calcul de la stratégie Momentum...")
    ...
    # Performance stats
    print("📊 Calcul des statistiques de performance...")
    stats = pd.concat(
        [
    ...
    # Save HTML
    output_file = 'backtest_report_FR.html'
